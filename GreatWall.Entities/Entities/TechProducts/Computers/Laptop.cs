namespace GreatWall.Entities.Entities.TechProducts.Computers
{
    ...
    public class Laptop : Product, IDisplay, IGraphicCard, IHardDrive, IMemory, IMotherboard, IOperationalSystem, IPowerSupply, IProcessor, IBattery
    {
        ...
        public Laptop(string displayType, bool touchScreen, string displayResolution,
